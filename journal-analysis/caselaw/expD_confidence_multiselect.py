...
Key read from the OPENROUTER_API_KEY environment variable. Raw responses appended to expD_raw_v3.jsonl (resumable);
analysis writes expD_numbers.json. 2026-07-21.
"""
...
RAW_PATH = HERE / 'expD_raw_v3.jsonl'
OUT_PATH = HERE / 'expD_numbers.json'
